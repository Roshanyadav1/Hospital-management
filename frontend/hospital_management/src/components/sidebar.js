...
//             {text:"Docter Detail", path:"/pages/docterdetail"},
//             {text:"Billing",path:"/pages/billing"},
//             {text:"Analytics",path:"/pages/analytics"},
//             {text:"Dashboard",path:"/pages/dashboardd"},
//             {text:"Appointment",path:"/pages/appoinment"},
//             {text:"About Hospital",path:"/pages/abouthospital"},
//            {text: "Prescription Management",path:"/pages/prescription"},
//            {text: "Discharge Summary",path:"/pages/discharge"},
//           ].map((text, index) => (
//             <ListItem
//               key={text}
//               disablePadding
...
//                   // }
//                 }}
//                 className={router.pathname === text.path ? "active" : ""}
//               >
//                 <ListItemIcon
//                   sx={{
//                     minWidth: 0,
...
//         {router.pathname === "/pages/appointment" && <Appointment />}
