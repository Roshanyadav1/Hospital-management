...
const columns = [
  { field: 'id', headerName: 'Header 1', width: 160, align: 'center', headerClassName: 'header1 column-line', cellClassName: 'column-line', sortable: false, headerAlign: 'center' },
  { field: 'firstName', headerName: 'Header 2', width: 160, align: 'center', headerClassName: 'header2 column-line', cellClassName: 'column-line', sortable: false, headerAlign: 'center' },
  { field: 'lastName', headerName: 'Header 3', width: 160, align: 'center', headerClassName: 'header34 column-line', cellClassName: 'column-line', sortable: false, headerAlign: 'center' },
  {
    field: 'age',
    headerName: 'Header 4',
    type: 'number',
