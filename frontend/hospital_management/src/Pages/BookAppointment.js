...
function BookAppoinment({ id, name }) {
   ...
   useEffect(() => {
      if (doctorTimes && doctorTimes.data && !isLoading) {
         setTimes(doctorTimes.data.times)
         setHiddentime(
            createTimeSlots(
               doctorTimes.data.per_patient_time,
               doctorTimes.data.times
            )
         )
      }
            ...
            <Grid item sm={6} xs={12}>
               ...
               >
                  ...
                  <Dialog open={openDialog} onClose={handleCloseDialog}>
                     ...
                     <DialogContent>
                        <DialogContentText>
                           Are you sure you want to book the appointment? An email
