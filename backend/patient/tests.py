...
class TestSetUp(APITestCase):
            ...
            def setUp(self):
                     ...
                     self.patient_view_url = reverse('patient profile view by id',kwargs={'input':self.test})
                     self.patient_update_url = reverse('patient profile update',kwargs={'input':self.test})
                     self.patient_delete_url = reverse('patient profile delete',kwargs={'input':self.test})
...
class PatientModelTestCase(TestCase):
       def test_model(self):
              ...
              patient = Patient.objects.create(patient_name=patient_name,patient_address=patient_address,patient_email=patient_email,password=password)
