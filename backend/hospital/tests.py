...
class TestSetUp(APITestCase):
            ...
            def setUp(self):
                     ...
                     self.hospital_view_url = reverse('hospital view by id',kwargs={'input':self.test})
                     self.hospital_delete_url = reverse('hospital delete',kwargs={'input':self.test})
                     self.hospital_update_url = reverse('hospital update',kwargs={'input':self.test})
...
class Testview(TestSetUp):
        def test_user_can_register(self):
              res =  self.client.post(self.hospital_register,self.hospital_data,format='json')
              pdb.set_trace
