...
urlpatterns = [
    ...
    path('view/<uuid:input>/', PrescriptionView.as_view(),
         name='prescription view by id'),
    path('delete/<uuid:input>/', PrescriptionDelete.as_view(),
         name='prescription delete'),
    path('update/<uuid:input>/', PrescriptionUpdate.as_view(),
